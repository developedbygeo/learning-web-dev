...
function handleActionButtonClick(event) {
  ...
  const roundScore = getGameScore(result, humanScore, computerScore);
...
function getGameScore(result, humanScore, computerScore) {
  if (result === "human-wins") return (humanScore += 1);
  else if (result === "computer-wins") return (computerScore += 1);
}
...
// ) {
//   computerScore += 1;
//} else if (       (formattedUserInput === rockButton &&
//    computerChoice === scissorsOption) ||
...
function playRound(humanChoice, computerChoice) {
  ...
  if (humanChoice === ROCK_OPTION && computerChoice === ROCK_OPTION) {
    ...
    humanChoice === ROCK_OPTION &&
    computerChoice === SCISSORS_OPTION
  ) {
    return "human-wins";
  } else if (humanChoice === PAPER_OPTION && computerChoice === PAPER_OPTION) {
    return "draw";
  } else if (
    humanChoice === PAPER_OPTION &&
    computerChoice === SCISSORS_OPTION
  ) {
    return "computer-wins";
    ...
    humanChoice === SCISSORS_OPTION &&
    computerChoice === SCISSORS_OPTION
  ) {
    return "draw";
  } else if (
    humanChoice === SCISSORS_OPTION &&
    computerChoice === ROCK_OPTION
  ) {
    return "computer-wins";
  } else if (
    humanChoice === SCISSORS_OPTION &&
    computerChoice === PAPER_OPTION
  ) {
    return "human-wins";
  } else {
    return "INVALID!!!!";
